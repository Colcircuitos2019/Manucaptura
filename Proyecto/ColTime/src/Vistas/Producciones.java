...
public class Producciones extends javax.swing.JFrame implements ActionListener {
    ...
    private void initComponents() {
        ...
        jSugerencia.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/question.png"))); // NOI18N
        jSugerencia.setToolTipText("");
        jPMenu.add(jSugerencia, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 20, -1, -1));
