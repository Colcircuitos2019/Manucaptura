...
public class jDMensaje extends javax.swing.JDialog {
    ...
    /**
     * Creates new form jDMensaje
     */
    public jDMensaje(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public void cerrar(){
        try {
            ...
            Logger.getLogger(jDMensaje.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jDMensaje.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jDMensaje dialog = new jDMensaje(new javax.swing.JFrame(), true);
